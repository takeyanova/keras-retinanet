...
def filter_detections(
    ...
    def _filter_detections(scores, labels):
        ...
        if nms:
            ...
            # perform NMS
            nms_indices = backend.non_max_suppression_with_scores(filtered_boxes, filtered_scores, max_output_size=max_detections, iou_threshold=nms_threshold,soft_nms_sigma=0.5)
